...
struct qmi_elem_info tmd_set_mitigation_level_resp_msg_v01_ei[] = {
	{
		...
		.array_type	= NO_ARRAY,
		.tlv_type	= 0x02,
		.offset	= offsetof(struct tmd_set_mitigation_level_resp_msg_v01,
					   resp),
		.ei_array	= qmi_response_type_v01_ei,
	},
	{
...
struct qmi_elem_info
	tmd_register_notification_mitigation_level_req_msg_v01_ei[] = {
	{
		...
		.array_type	= NO_ARRAY,
		.tlv_type	= 0x01,
		.offset	= offsetof(struct tmd_register_notification_mitigation_level_req_msg_v01,
					   mitigation_device),
		.ei_array	= tmd_mitigation_dev_id_type_v01_ei,
	},
	{
...
struct qmi_elem_info
	tmd_register_notification_mitigation_level_resp_msg_v01_ei[] = {
	{
		...
		.array_type	= NO_ARRAY,
		.tlv_type	= 0x02,
		.offset	= offsetof(struct tmd_register_notification_mitigation_level_resp_msg_v01,
					   resp),
		.ei_array	= qmi_response_type_v01_ei,
	},
	{
...
struct qmi_elem_info
	tmd_deregister_notification_mitigation_level_req_msg_v01_ei[] = {
	{
		...
		.array_type	= NO_ARRAY,
		.tlv_type	= 0x01,
		.offset	= offsetof(struct tmd_deregister_notification_mitigation_level_req_msg_v01,
					   mitigation_device),
		.ei_array	= tmd_mitigation_dev_id_type_v01_ei,
	},
	{
...
struct qmi_elem_info
	tmd_deregister_notification_mitigation_level_resp_msg_v01_ei[] = {
	{
		...
		.array_type	= NO_ARRAY,
		.tlv_type	= 0x02,
		.offset	= offsetof(struct tmd_deregister_notification_mitigation_level_resp_msg_v01,
					   resp),
		.ei_array	= qmi_response_type_v01_ei,
	},
	{
